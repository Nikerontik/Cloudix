const dict = {
  ru: {
    ...
    settings: {
      ...
      exportProfile: "Скачать профиль",
      exportHint:
        "Сохраняет профиль в файл: имя, никнейм, аватар, оформление и ваш Peer ID. С ним вас узнают прежние собеседники.",
      exportDone: "Профиль сохранён:",
      importProfile: "Импортировать профиль",
      importHint: "Заменит текущий профиль данными из файла.",
      wipeHint:
        "Удаляет базу целиком: профиль, переписку, медиа, журнал звонков и ключи. Восстановить будет нечем.",
    },
    callLog: {
      ...
      clearConfirm: "Удалить весь журнал звонков? Это действие нельзя отменить.",
    ...
    decor: {
      ...
      pattern: "Узор",
      none: "Нет",
      hint: "Фон и узор видят все ваши собеседники.",
      colors: {
        red: "Красный",
        orange: "Оранжевый",
        purple: "Фиолетовый",
  ...
  en: {
    ...
    settings: {
      ...
      backup: "Backup",
      exportProfile: "Download profile",
      exportHint:
        "Saves your profile to a file: name, nickname, avatar, look and your Peer ID. With it, the people who already know you still recognise you.",
      exportDone: "Profile saved:",
      importProfile: "Import profile",
      importHint: "Replaces the current profile with the one in the file.",
      wipeHint:
        "Deletes the whole database: profile, conversations, media, call log and keys. Nothing is left to restore from.",
    },
    callLog: {
      title: "Call log",
      empty: "No calls yet.",
      ...
      callBack: "Call",
      clear: "Clear log",
      clearConfirm: "Delete the whole call log? This cannot be undone.",
      duration: "Duration",
      today: "Today",
      yesterday: "Yesterday",
    },
    ...
    decor: {
      ...
      pattern: "Pattern",
      none: "None",
      hint: "Everyone you talk to sees your background and pattern.",
      colors: {
        red: "Red",
        orange: "Orange",
        purple: "Purple",
